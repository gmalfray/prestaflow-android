...
App Android (Kotlin, Jetpack Compose, Material Design 3, CI/CD, Crashlytics) pour gérer des boutiques PrestaShop via le module Rebuild Connector.

## Objectif

Gérer sa boutique PrestaShop depuis un smartphone :
- Suivi des commandes, produits, stocks et clients (filtres statut, stock, recherche)
...
- Impression des factures (PDF officiel, montage 2 par page A4 paysage) et des bordereaux d’expédition
...
- MVP livré : Commandes, Produits, Clients, Dashboard, Notifs
- v1 livrée : filtres, multi-boutiques, notifications par catégorie, impression factures, onboarding
- À venir : statistiques avancées, édition images produits, relance paniers
...
GPLv3 est une licence *copyleft* : toute version modifiée qui est **distribuée** doit l’être sous GPLv3 avec son
code source. Le module serveur Rebuild Connector est distribué séparément sous OSL-3.0 ; l’app et le module
communiquent uniquement par API REST, sans aucune liaison de code.
