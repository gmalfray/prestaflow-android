...
class ClientsViewModelTest {
    ...
    @Test
    fun `visibleClients filtre par nom complet insensible a la casse`() =
        runTest {
    ...
    @Test
    fun `visibleClients filtre par email insensible a la casse`() =
        runTest {
            fakeClientsRepo.setClients(
                listOf(
                    buildClient(1L, firstName = "Alice", lastName = "Martin", email = "alice@test.fr"),
    ...
    @Test
    fun `visibleClients retourne tous les clients si query est vide`() =
        runTest {
            fakeClientsRepo.setClients(
    ...
    @Test
    fun `un echec de refreshTopClients avec onRefresh expose une erreur dans l etat`() =
        runTest {
